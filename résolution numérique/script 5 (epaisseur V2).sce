...
conditionAuBordN(M,1) = D*dt*valeurAuBordN/(dz*dz);
NCourant = N0;
...
matriceDeriveePremiere = surDiag - sousDiag; // pour calculer les dérivées de L,A,N
matriceDeriveePremiere(M,M-1) = 0;
matriceDeriveePremiere(1,2) = 0;

matriceDeriveeSeconde = -2*identity + surDiag + sousDiag;
matriceDeriveeSeconde(1,2) = 2; 
...
frequenceStockage = 10000; // on en garde 1/fréquenceStockage en fait
