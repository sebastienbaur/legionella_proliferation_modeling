...
// constantes de Monod : 
k_1 = 25*10^(-5)*exp(-((Temperature - T_opt_L)/(T_i_L - T_opt_L))^2) ; // constante de vitesse légionnelle-nutriment
k_2 = 0.2 ;
k_3 = 9; // constante de vitesse légionnelle-amibe
//k_4 = 0.2 ;
k_5 = 30*10^(-5)*exp(-((Temperature - T_opt_A)/(T_i_A - T_opt_A))^2) ; // constante de vitesse amibe-nutriment
k_6 = 0.2 ;
...
// fraction volumique de la matrice polymère
epsilon = 0.3;
